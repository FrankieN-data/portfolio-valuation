...
def ingest_vanguard_pension_cash():
    # 1. Setup Paths
    base_path = os.path.join(SCRIPT_DIR, '../..')
    raw_file = os.path.join(base_path, 'data', 'raw', 'vanguard_pension_cash.csv')
    bronze_file = os.path.join(base_path, 'data', 'bronze', 'vanguard_pension_cash.parquet')
