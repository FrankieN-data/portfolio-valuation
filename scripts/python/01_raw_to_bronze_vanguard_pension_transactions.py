...
def ingest_vanguard_pension_transactions():
    ...
    raw_file = os.path.join(base_path, 'data', 'raw', 'vanguard_pension_transactions.csv')
    bronze_file = os.path.join(base_path, 'data', 'bronze', 'vanguard_pension_transactions.parquet')
