...
def ingest_vanguard_pension_cash_statement():
    # 1. Setup Paths
    config = get_config()
    raw_file = config['paths']['raw'] / "vanguard_pension_cash_statement.csv"
    bronze_path = config['paths']['bronze']
    bronze_file = bronze_path / "vanguard_pension_cash_statement.parquet"
...
if __name__ == "__main__":
    ingest_vanguard_pension_cash_statement()