...
-- Run: duckdb -init 01_raw_to_bronze_vanguard_pension_transactions.sql
...
-- Convert vanguard_pension_transactions.csv → vanguard_pension_transactions.parquet (with explicit types)
-- trade_date: DATE
